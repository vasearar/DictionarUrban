  ...
  return (
    ...
    <div className="w-screen h-screen flex items-center justify-center flex-col font-Unbounded">
      ...
      <div className="bg-transparent p-3 md:p-6 rounded-lg flex items-center justify-center flex-col">
        ...
        <div className="flex items-center max-w-[367px] md:max-w-fit justify-center mt-12 gap-2">
          ...
          <p className="md:text-base text-sm">Am citit și sunt de acord cu <Link href={"#"} className="text-myorange md:hover:text-myhoverorange transition-all">Termenii și Condiții</Link> și <Link href={"#"} className="text-myorange md:hover:text-myhoverorange transition-all">Politică de Confidențialitate</Link></p>
        </div>
      </div>
    </div>
    </Suspense>
