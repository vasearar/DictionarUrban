  ...
  return (
    <div className='w-full flex justify-between my-12 font-Spacegrotesc'>
      <div className='mx-auto flex justify-between w-[71%]'>
        ...
        <div>
          <div className='flex'>
            <button className='border-2 flex items-center gap-2 relative px-4 tracking-wide h-fit py-2 text-white font-bold border-mygray transition-all bg-myorange hover:bg-myhoverorange mydropshadow'>
          ...
          <button className='mt-5 ml-auto flex items-center gap-2 border-2 relative px-4 tracking-wide h-fit py-2 text-white bg-red-600 transition-all hover:bg-red-400 font-bold border-mygray mydropshadow'>
              Șterge cont
          </button>
        </div>
      </div>
