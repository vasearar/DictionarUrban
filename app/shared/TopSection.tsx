...
export default async function TopSection() {
  return (
    <div className='mx-auto text-center px-3 md:px-8'>
      ...
      <div className='rounded-md text-nowrap mb-7 bg-mywhite mx-auto px-3 pt-3 pb-7 lg:p-8 max-w-[720px] justify-center flex-col lg:flex-row items-center border-2 border-mygray flex gap-4 lg:gap-16 relative mybigdropshadowrounded'>
